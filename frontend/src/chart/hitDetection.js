...
// ⚠ 단위 `BTC`를 뗀 만큼 폭도 같이 줄였다 (60 → 36, 2026-08-22).
//   안 줄이면 다섯 글자(`0.173`)만 든 배지에 좌우 여백이 20px 넘게 남아 혼자 커 보인다.
//   36은 그 글자가 들어가는 최소치에 맞춘 값 — 자릿수를 늘리려면 여기도 같이 올릴 것
export const QTY_BADGE = { w: 36 };
