...
//   커스텀 구조의 자동 구간이 서로 다른 자리에 꼭짓점을 찍는다.
//   사용자가 정한 계약이다 (2026-09-09): **찍은 점까지는 수동, 그 뒤는 자동 구조의
//   알고리즘 그대로.** 그래서 찍은 점들이 자동 구조의 꼭짓점과 같은 자리면 그 뒤 결과도
//   같아야 한다. 검산은 `tests/structAutoMirror.test.js`.
//   ※ 여기 적혀 있던 "둘을 나란히 켜고 눈으로 맞춰보는 게 이 기능의 쓸모"는 근거 없는
//     서술이었다 — 2026-09-09에 사용자가 아니라고 확인해 줘서 위 문장으로 바꿨다.
//
